...
const EroticMonkey = () => {
  ...
  const { isUserAuthenticated, userData, myEroticMonkeyItems } = useOutletContext()

  const allData = myEroticMonkeyItems?.slice()?.sort((a, b) => b?.createdAt - a?.createdAt)
